...
ARGUMENTS = cfg["mt5"]["args"]
LORA_CONFIG = cfg["mt5"]["lora_config"]
...
def setup_wandb():
    ...
    wandb.init(project=WANDB_PROJECT, name="mt5-finetune-lora")


def load_model_and_tokenizer():
    """Load the mBART model and tokenizer."""
    tokenizer = MT5TokenizerFast.from_pretrained(MODEL_NAME, legacy=False)
...
def main():
    ...
    # Preprocess datasets
    preprocessor = TextPreprocessor(tokenizer, MAX_LEN, name="mt5")
